...
def average_vowels_and_consonants(paragraph):
    ...
    for sentence in sentences:
        results = counting_vowels_and_consonants(sentence)
        v = results[0]
        c = results[1]
        total_vowels += v
        total_consonants += c
...
print(f"The average number of vowels in the paragraph is: {result[1]}")
print(f"The average number of consonants in the paragraph is: {result[2]}")